...
class TestMainErrorHandling:
    ...
    def test_main_catches_proton_fetcher_error(self, mocker, tmp_path, capsys):
        ...
        try:
            ...
            mock_fetcher_class = mocker.patch("protonfetcher.cli.GitHubReleaseFetcher")
            mock_fetcher_instance = mocker.Mock()
            mock_fetcher_instance.fetch_and_extract.side_effect = ProtonFetcherError(
                "Test error"
            )
    ...
    def test_main_with_ls_flag_error(self, mocker, tmp_path, capsys):
    ...
    def test_main_with_list_flag_error(self, mocker, tmp_path, capsys):
        ...
        try:
            ...
            mock_fetcher_instance.release_manager.list_recent_releases.side_effect = (
                ProtonFetcherError("Test error for list")
            )
            mock_fetcher_class.return_value = mock_fetcher_instance
    ...
    def test_main_with_rm_flag_error(self, mocker, tmp_path, capsys):
